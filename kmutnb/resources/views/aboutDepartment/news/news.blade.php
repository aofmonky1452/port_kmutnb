...
@section('content')
    <div class="vue-container">
        <div class="title-head">
            ...
            <a href="{{route('aboutDepartment_Add')}}" class="btn-addAboutDepartment"><i class="fas fa-plus-circle"></i>เพิ่มข่าว</a>
        </div>
        ...
        <div class="news-container">
            ...
            <div class="news-info">
                ...
                <div class="news-bottom">
                    ...
                    <a class="btn-readmore" href="{{route('newsDetail')}}">อ่านต่อ</a>
                </div>
            </div>
            {{-- card-news --}}
            <div class="news-info">
